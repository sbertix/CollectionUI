...
public struct LegacyCollectionView<Content>: UIViewControllerRepresentable where Content: UICollectionViewCellRepresentable {
    ...
    // MARK: Representable
    public func makeUIViewController(context: UIViewControllerRepresentableContext<LegacyCollectionView<Content>>) -> UICollectionViewController {
        /// the actual layout.
    ...
    public func updateUIViewController(_ uiViewController: UICollectionViewController,
                                       context: UIViewControllerRepresentableContext<LegacyCollectionView<Content>>) {
    }
    ...
    public class CollectionCoordinator<Content>: NSObject, UICollectionViewDataSource where Content: UICollectionViewCellRepresentable {
        /// The parent.
        var parent: LegacyCollectionView<Content>

        // MARK: Lifecycle
        init(_ collectionViewController: LegacyCollectionView<Content>) {
